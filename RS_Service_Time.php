...
<html>
                                    ...
                                    ({
                                        ...
                                        data: { Open_Time:Open_Time,Close_Time:Close_Time,Service_Time:Service_Time,
                                            ...
                                            success: function(response) {
                                             ...
                                             {
                                                 alert(result.msg);
                                                 window.location.href="RS_Service_Time.php";
                                             }
                                             else
                                             {
                                                 alert(result.msg);
    ...
    <body>
        <div class="wrapper" style="margin:0 auto;" >
            <h2 style="color:#b5651d;">Ration Shop - Set Service Time</h2>
 

            <table class="table">
                
                <?php
                $sql = "SELECT s.* from ration_shop_register s where s.RS_INC_ID='$user_id' order by s.RS_INC_ID asc";

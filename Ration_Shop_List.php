...
<html>
    <head>
        <meta charset="UTF-8">
        <title>e-Shopping - Ration Shop List</title>
<!--        <p style="float: right;font-size:20px;color: orchid;"><u>User Name</u>: <?php echo $_SESSION['User_Name']?><br><u>User Category</u>: <?php if ($_SESSION['user_category'] === "IU") echo "Individual User"; else if($_SESSION['user_category'] === "GO") echo "Government Official" ; else echo "Shop Keeper"; ?></p>-->
    ...
    <body>
        <div class="wrapper" style="margin:0 auto;" >
            <h2 style="color:#b5651d;">Ration Shop List</h2>
            ...
            <table class="table">
                ...
                $sql = "SELECT * FROM ration_shop_register where PINCODE = '$PINCODE' order by PINCODE,RS_REG_NUM asc LIMIT $offset,$no_of_records_per_page";

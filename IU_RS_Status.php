...
<html>
    <head>
        <meta charset="UTF-8">
        <title>e-Shopping - Ration Purchase - Order Status</title>
            ...
            $(function(){
                $('input[id$="Delivered"]').click(function () 
                {
                   ...
                   //window.location.href= "Update_Order_Status.php?order_id="+order_id;
                    $.ajax({
                        type: 'POST',
                        url: 'Update_RS_Order_Delivery.php',
    ...
    <body>
        <div class="wrapper" style="margin:0 auto;" >
            <h2 style="color:#b5651d;">Ration Purchase - Order Status</h2>
            ...
            <table class="table" style="text-align:center;">
                ...
                $Service_time = "";
                $sql = "SELECT u.*,s.HD_Service_Time,s.Service_Time,s.BUILD_NO,s.STREET,s.CITY,s.DISTRICT,s.STATE,s.PINCODE FROM ration_shop_order u,ration_shop_register s where u.USER_ID='$user_id' and u.ORDER_STATUS > 1 and u.ORDER_STATUS !=4 and s.RS_INC_ID = u.SHOP_ID order by u.ORDER_DATE desc";

...
<html>
    <head>
        <meta charset="UTF-8">
        <title>List of Donated Relief Material</title>
    ...
    <body>
        <div class="wrapper" style="margin:0 auto;" >
            <h2 style="color:#b5651d;">List of Donated Relief Material</h2>
            ...
            <table class="table">
                ...
                $total_pages_sql = "SELECT count(*) FROM relief_material_registration where user_id = '$USER_ID' ORDER BY Exp_Date desc";
                $result_sql = mysqli_query($MyConnection,$total_pages_sql);
                $total_rows = mysqli_fetch_array($result_sql)[0];
                $total_pages = ceil($total_rows / $no_of_records_per_page);

                $sql = "SELECT * FROM relief_material_registration where user_id = '$USER_ID' ORDER BY Exp_Date desc LIMIT $offset,$no_of_records_per_page";
